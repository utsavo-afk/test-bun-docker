...
```bash
$ docker build -t nestjs-bun-demo .
```

### Run Docker Container

```bash
$ docker run -p 3000:3000 nestjs-bun-demo
```
...
- Pushes to GHCR on every push to `main` branch
- Tags images with version numbers and commit SHA

**To enable:**
1. Push your code to GitHub
2. Ensure GitHub Actions has write permissions for packages (Settings → Actions → General → Workflow permissions)
